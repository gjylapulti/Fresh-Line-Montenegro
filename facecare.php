...
<a href="logout.php">Logout</a>
    ...
    <div class="container">
        ...
        <div class="products">
            ...
            <div class="product">
                <div class="image">
                    <img src="pictures/elixirorchidea.jpg" alt="">
                </div>
                <div class="namePrice">
            ...
            <div class="product">
                <div class="image">
                    <img src="pictures/elixirorchideanight.jpg" alt="">
                </div>
                <div class="namePrice">
            ...
            <div class="product">
                <div class="image">
                    <img src="pictures/hesperides.jpg" alt="">
                </div>
                <div class="namePrice">
                    <h3>Hesperides</h3>
                    <span>$ 20.99</span>
            ...
            <div class="product">
                <div class="image">
                    <img src="pictures/hesperidesacne.jpg" alt="">
                </div>
                <div class="namePrice">
            ...
            <div class="product">
                <div class="image">
                    <img src="pictures/nectar.jpg" alt="">
                </div>
                <div class="namePrice">
                    <h3>Nectar</h3>
                    <span>$ 20.99</span>
